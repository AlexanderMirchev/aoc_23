...
defmodule Day1 do
  ...
  def replace_numbers("one" <> rest), do: "1" <> replace_numbers("e" <> rest)
  def replace_numbers("two" <> rest), do: "2" <> replace_numbers("o" <> rest)
  def replace_numbers("three" <> rest), do: "3" <> replace_numbers("e" <> rest)
  def replace_numbers("four" <> rest), do: "4" <> replace_numbers("r" <> rest)
  def replace_numbers("five" <> rest), do: "5" <> replace_numbers("e" <> rest)
  def replace_numbers("six" <> rest), do: "6" <> replace_numbers("x" <> rest)
  def replace_numbers("seven" <> rest), do: "7" <> replace_numbers("n" <> rest)
  def replace_numbers("eight" <> rest), do: "8" <> replace_numbers("t" <> rest)
  def replace_numbers("nine" <> rest), do: "9" <> replace_numbers("e" <> rest)
  def replace_numbers(<<char, rest::binary>>), do: <<char>> <> replace_numbers(rest)
  def replace_numbers(""), do: ""
end

# IO.puts("Solution: #{Day1.solution_pt1(input)}")
IO.puts("Solution2: #{Day1.solution_pt2(input)}")
