...
defmodule Day2 do
  ...
  def game_valid({_, samples}) do
    result = samples
    |> Enum.all?(&sample_valid/1)
    result
  end

  def sample_valid(%Sample{red: red, blue: blue, green: green}) when red <= 12 and green <= 13 and blue <=14 do
    true
  end
